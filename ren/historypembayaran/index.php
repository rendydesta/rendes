...
<body style="background-image: linear-gradient(113.31deg, #01004A -6.87%, #00FFF0 135.64%);">
    <section class="vh-100 gradient-custom">
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
              <ul class="navbar-nav">
                ...
                <li class="nav-item ms-4">
                  ...
                  <li class="nav-item ms-4">
                    <a class="nav-link active" href="#"><b>Lihat History Pembayaran</b></a>
                  </li>
        ...
        <h2 class="text-center fw-bold mb-3 mt-2" style="color: white;">Entri Pembayaran</h2><br>
    <?php
    ...
    ?>
    <center>
    <button type="button" class="btn btn-primary"><a href="../entripembayaran/add.php" style="color: white;">Tambahkan Entri Pembayaran</a></button><br/><br/>
    <table width="80%" border="1" class="text-center">
        ...
        <?php
        include "../entripembayaran/config.php";
        $no = 1;
