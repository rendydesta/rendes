...
<body class="text-center" style="background-image: linear-gradient( #899c95 , #185c43 );">
    <section class="vh-100 gradient-custom">
        ...
        <h2 class="text-center fw-bold mb-3 mt-2" style="color: dark;">Tambahkan Data Kelas</h2>        
 
    <form action="add.php" method="post" name="form1">
        <table width="80%" border="1" class="text-center">
        <center><div class="mb-3 col-sm-6">
        <input class="form-control form-control-lg" placeholder="ID Kelas" name="id_kelas" required></div>
        <div class="mb-3 col-sm-6">
          <input class="form-control form-control-lg" placeholder="Kelas" name="kelas" required></div>
          <select name="jurusan" class="mb-5">
    ...
    if(isset($_POST['Submit'])) {
        ...
        $result = mysqli_query($mysqli, "INSERT INTO users(id_kelas, kelas, jurusan) VALUES('$id_kelas','$kelas','$jurusan')");
