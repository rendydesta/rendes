...
<body style="background-image: linear-gradient( #899c95 , #185c43 );">
    <section class="vh-100 gradient-custom">
        ...
        <nav class="navbar navbar-expand-lg navbar navbar-light bg-light">
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
              <ul class="navbar-nav">
                ...
                <li class="nav-item ms-4">
                    <a class="nav-link active" href="#"><b>Data SPP</b></a>
                  </li>
                  <li class="nav-item ms-4">
        ...
        <h2 class="text-center fw-bold mb-3 mt-2" style="color: dark;">Data SPP</h2><br>
    <?php
    ...
    ?>
    <center>
    <button type="button" class="btn btn-secondary"><a href="add.php" style="color: white;">Tambahkan Data SPP</a></button><br/><br/>
