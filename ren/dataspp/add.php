...
<body class="text-center" style="background-image: linear-gradient( #899c95 , #185c43 );">
    <section class="vh-100 gradient-custom">
        ...
        <h2 class="text-center fw-bold mb-3 mt-2" style="color: dark;">Tambahkan Data SPP</h2>        
 
    <form action="add.php" method="post" name="form1">
        <table width="80%" border="1" class="text-center">
        <center><div class="mb-3 col-sm-6">
        <input class="form-control form-control-lg" placeholder="ID SPP" name="id_spp" required></div>
        <div class="mb-3 col-sm-6">
          <input class="form-control form-control-lg" type="date" placeholder="Tahun" name="tahun" required></div>
        <div class="mb-3 col-sm-6">
          <input type="password" class="form-control form-control-lg" placeholder="Password" name="nominal" required></div>            
    ...
    if(isset($_POST['Submit'])) {
        ...
        $result = mysqli_query($mysqli, "INSERT INTO users(id_spp, tahun, nominal) VALUES('$id_spp','$tahun','$nominal')");
